                  ...
                  <div className="mt-5 h-0 flex-1 overflow-y-auto">
                    <nav className="space-y-1 px-2">
                      {navigation.map((item) => (
                        ...
                        >
                          <item.icon className="mr-4 h-6 w-6 flex-shrink-0 text-sky-300" aria-hidden="true" />
                          {item.name}
                        </a>
                      ))}
                    </nav>
            ...
            <div className="mt-5 flex flex-1 flex-col">
              <nav className="flex-1 space-y-1 px-2 pb-4">
                {navigation.map((item) => (
                  ...
                  >
                    <item.icon className="mr-3 h-6 w-6 flex-shrink-0 text-sky-300" aria-hidden="true" />
                    {item.name}
                  </a>
                ))}
              </nav>
